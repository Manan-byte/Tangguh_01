...
const specs = [
  ...
  { icon: Battery, label: "Jarak Tempuh", value: "80 km" },
        ...
        <div className="container-custom relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute -bottom-4 -right-4 px-6 py-3 rounded-2xl bg-card border border-border shadow-xl">
                ...
                <div className="font-display font-bold text-2xl text-primary">Rp 55 Juta</div>
              </div>
            </motion.div>
            ...
            >
              <span className="px-4 py-1.5 rounded-full bg-emerald-500/10 text-emerald-500 text-sm font-medium mb-4 inline-block">
                Ready to Race
              </span>
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                Dirancang khusus untuk para profesional yang haus akan kecepatan dan ketangguhan di setiap lintasan. Didukung teknologi unggulan dan desain aerodinamis yang memberikan pengalaman racing tak tertandingi.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {specs.map((spec, index) => (
                  ...
                  >
                    <spec.icon className="w-6 h-6 text-emerald-500 mx-auto mb-2" />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="hero" size="lg" asChild>
                  <a href="https://wa.me/628567360026?text=Halo,%20saya%20tertarik%20dengan%20motor%20DX4" target="_blank" rel="noopener noreferrer">
                    Pesan Sekarang
                  </a>
                </Button>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <h2 className="font-display font-bold text-3xl text-foreground mb-8">
                Fitur <span className="text-emerald-500">Unggulan</span>
              </h2>
            ...
            >
              <div className="p-6 rounded-2xl bg-card border border-border">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">3 Tahun garansi mesin</p>
                  </div>
                </div>
              ...
              <div className="p-6 rounded-2xl bg-card border border-border">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-lg text-foreground">Service Premium</h3>
                    <p className="text-sm text-muted-foreground">Gratis 5x service</p>
                  </div>
                </div>
                <p className="text-muted-foreground">
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
                <h3 className="font-display font-semibold text-lg mb-2">Tertarik dengan DX4?</h3>
                <p className="text-white/80 mb-4">
                  Hubungi kami untuk informasi lebih lanjut dan jadwalkan test ride.
                </p>
                <Button variant="secondary" size="sm" asChild>
                  <a href="https://wa.me/628567360026?text=Halo,%20saya%20ingin%20test%20ride%20DX4" target="_blank" rel="noopener noreferrer">
                    Jadwalkan Test Ride
                  </a>
                </Button>
              </div>
