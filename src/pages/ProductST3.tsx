...
const ProductST3 = () => {
  ...
  const features = language === "id" ? [
    ...
    "Dual purpose for rough terrain and highways",
    "Adaptive suspension system for maximum comfort",
    "Lithium-ion battery with fast charging",
    "Regenerative braking system",
    "LCD display with various information",
    "Suitable for beginners to intermediate users",
  ];

  const whatsappOrderMsg = language === "id" 
    ? "Halo, saya tertarik dengan motor ST3"
    : "Hello, I am interested in the ST3 motorcycle";
  const whatsappTestRideMsg = language === "id"
    ? "Halo, saya ingin test ride ST3"
    : "Hello, I want to schedule a test ride for ST3";

  // Simple fade animation for mobile, full animations for desktop
  const fadeIn = {
    ...
    <main className="min-h-screen bg-background">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "ST3", url: "https://tangguhev.com/produk/st3" },
        ]}
      />
      <Navbar />
      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 relative overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          >
            <ProductBreadcrumb productName="ST3" productSlug="st3" />
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div 
              ...
              className="relative"
            >
              <div className="aspect-square rounded-2xl md:rounded-3xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-background/10 backdrop-blur-[1px]" />
                <span className="text-[120px] md:text-[200px] font-display font-bold text-foreground/20 select-none">ST3</span>
              </div>
              <div className="absolute -bottom-3 -right-3 md:-bottom-4 md:-right-4 px-4 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl bg-card border border-border shadow-xl">
                ...
                <div className="font-display font-bold text-xl md:text-2xl text-primary">Rp 35 Juta</div>
              </div>
            </motion.div>
            ...
            >
              <span className="px-3 md:px-4 py-1 md:py-1.5 rounded-full bg-cyan-500/10 text-cyan-500 text-xs md:text-sm font-medium mb-4 inline-block">
                {t.products.st3.tagline}
              </span>
              <h1 className="font-display font-bold text-3xl md:text-4xl lg:text-6xl text-foreground mb-4 md:mb-6">ST3</h1>
              <p className="text-muted-foreground text-base md:text-lg mb-6 md:mb-8 leading-relaxed">{t.products.st3.description}</p>
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-4 mb-6 md:mb-8">
                {specs.map((spec, index) => (
                  ...
                  >
                    <spec.icon className="w-5 h-5 md:w-6 md:h-6 text-cyan-500 mx-auto mb-1 md:mb-2" />
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="font-display font-bold text-2xl md:text-3xl lg:text-4xl text-foreground">
              {t.productDetail.features} <span className="text-cyan-500">{t.productDetail.featuresHighlight}</span>
            </h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              >
                <div className="flex items-center gap-3 mb-3 md:mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center">
                    <Shield className="w-5 h-5 md:w-6 md:h-6 text-cyan-500" />
                  </div>
                  <div>
                ...
                <p className="text-muted-foreground text-sm md:text-base">
                  {language === "id" 
                    ...
                    : "Every ST3 purchase comes with 2 years official warranty for engine and 1 year for battery."}
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-3 md:mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center">
                    <Wrench className="w-5 h-5 md:w-6 md:h-6 text-cyan-500" />
                  </div>
                  <div>
                    <h3 className="font-display font-semibold text-base md:text-lg text-foreground">{t.productDetail.service}</h3>
                    <p className="text-xs md:text-sm text-muted-foreground">{t.productDetail.serviceFree} 3x service</p>
                  </div>
                </div>
                <p className="text-muted-foreground text-sm md:text-base">
                  {language === "id"
                    ? "Dapatkan layanan service gratis sebanyak 3 kali selama tahun pertama pembelian."
                    : "Get 3 free service sessions during the first year of purchase."}
                </p>
              </motion.div>
              ...
              <motion.div 
                ...
                className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white"
              >
                <h3 className="font-display font-semibold text-base md:text-lg mb-2">{t.productDetail.interested} ST3?</h3>
