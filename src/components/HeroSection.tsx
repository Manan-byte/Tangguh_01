        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-primary text-sm font-medium">
              ...
              Inovasi Kendaraan Listrik Indonesia
            </span>
          </motion.div>
          ...
          >
            Motor trail listrik dengan performa tinggi tanpa emisi. Rasakan sensasi 
            berkendara yang tangguh dan ramah lingkungan.
          </motion.p>
          ...
          >
            ...
            <Button variant="outline" size="lg" asChild>
              <a href="#konversi">Konversi Motor</a>
            </Button>
          </motion.div>
          ...
          >
            {[
              { icon: Zap, value: "100%", label: "Listrik" },
              { icon: Leaf, value: "0", label: "Emisi" },
              { icon: Award, value: "∞", label: "Petualangan" },
            ].map((stat, index) => (
